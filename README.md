...
- **Frontend:** React, TypeScript, JavaScript (ES6+), Next.js, Tailwind CSS, HTML5/CSS3
- **Backend & DB:** Node.js, REST APIs, PostgreSQL
- **DevOps & Workflow:** Docker, Git / GitLab, npm / yarn
...
*A full-stack MVP application written completely from scratch, featuring an autonomous AI assistant.*
...
- **Key Contributions:** Transformed complex Figma layouts into robust, cross-browser, and fully adaptive React code. Collaborated closely with Go backend developers to integrate REST APIs and managed production-ready code inside GitLab.
- **Tech Stack:** React, TypeScript, Tailwind CSS, GitLab, Docker, Go (API sync).
- **Role:** Frontend Developer (currently supporting and updating both production live sites).
